  ...
  const moduloCrud = {
    ...
    globales: () => {
      ...
      $('#modalEditModulo').on('show.bs.modal', function (e) {
        ...
        if (moduloCrud.variables.rolEdit?.img) {
          let rutaArchivo = moduloCrud.variables.rolEdit?.img; 
          agregarArchivoADropzone(rutaArchivo, moduloCrud.variables.myDropzoneEditModulo);
        }
      });
