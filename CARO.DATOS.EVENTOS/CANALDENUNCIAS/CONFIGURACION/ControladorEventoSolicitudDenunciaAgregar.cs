...
{
    public class ControladorEventoSolicitudDenunciaAgregar : IRequestHandler<ComandoSolicitudDenunciaAgregar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorEventoSolicitudDenunciaAgregar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoSolicitudDenunciaAgregar entidad, CancellationToken cancellationToken)
        {
