...
{
    public class ControladorEventoClienteEditar : IRequestHandler<ComandoClienteEditar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorEventoClienteEditar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoClienteEditar entidad, CancellationToken cancellationToken)
        {
