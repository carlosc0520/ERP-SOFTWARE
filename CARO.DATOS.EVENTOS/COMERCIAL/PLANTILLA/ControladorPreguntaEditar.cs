...
{
    public class ControladorPreguntaEditar : IRequestHandler<ComandoPreguntaEditar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorPreguntaEditar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoPreguntaEditar entidad, CancellationToken cancellationToken)
        {
