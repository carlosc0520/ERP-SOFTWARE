...
{
    public class ControladorCursoInsertar : IRequestHandler<ComandoCursoInsertar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorCursoInsertar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoCursoInsertar entidad, CancellationToken cancellationToken)
        {
