...
{
    public class ControladorClienteXCasoEliminar : IRequestHandler<ComandoClienteXCasoEliminar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorClienteXCasoEliminar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoClienteXCasoEliminar entidad, CancellationToken cancellationToken)
        {
