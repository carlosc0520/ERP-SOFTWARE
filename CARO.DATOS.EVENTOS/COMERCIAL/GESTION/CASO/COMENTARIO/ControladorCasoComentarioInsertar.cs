...
{
    public class ControladorCasoComentarioInsertar : IRequestHandler<ComandoCasoComentarioInsertar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorCasoComentarioInsertar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoCasoComentarioInsertar entidad, CancellationToken cancellationToken)
        {
