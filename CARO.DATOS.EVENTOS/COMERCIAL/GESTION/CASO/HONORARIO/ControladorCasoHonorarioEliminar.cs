...
{
    public class ControladorCasoHonorarioEliminar : IRequestHandler<ComandoCasoHonorarioEliminar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorCasoHonorarioEliminar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoCasoHonorarioEliminar entidad, CancellationToken cancellationToken)
        {
