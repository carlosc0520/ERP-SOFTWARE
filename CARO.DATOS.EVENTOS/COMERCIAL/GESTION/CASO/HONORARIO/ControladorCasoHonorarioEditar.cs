...
{
    public class ControladorCasoHonorarioEditar : IRequestHandler<ComandoCasoHonorarioEditar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorCasoHonorarioEditar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoCasoHonorarioEditar entidad, CancellationToken cancellationToken)
        {
