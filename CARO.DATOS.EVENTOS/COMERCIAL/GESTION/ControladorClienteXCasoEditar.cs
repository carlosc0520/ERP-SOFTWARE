...
{
    public class ControladorClienteXCasoEditar : IRequestHandler<ComandoClienteXCasoEditar, RespuestaConsulta>
    {
        private readonly IConfiguration _configuration;

        public ControladorClienteXCasoEditar(IConfiguration configuration)
        {
            _configuration = configuration;
        }

        public async Task<RespuestaConsulta> Handle(ComandoClienteXCasoEditar entidad, CancellationToken cancellationToken)
        {
